...
import { View, Text, StyleSheet, Pressable, TouchableOpacity, Alert, Linking } from 'react-native';
        ...
        <SafeAreaView style={s.screen} edges={['top']}>
            ...
            <View>
                ...
                <Text style={s.paragraph}>
                    Hello! We're a small development team, responding to everyone may take a while.
                    For any questions or complaints regarding our application,
                    Please contact us and we'll get back to you as soon as possible.
                </Text>

                <Text style={s.thank_you_message}>❤️ Thank you for supporting us. ❤️</Text>
            </View>
