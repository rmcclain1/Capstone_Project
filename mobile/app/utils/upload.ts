...
export function buildProfileFormData(
  ...
  if (payload.username != null)
    fd.append("user[username]", String(payload.username));
  if (payload.email != null) fd.append("user[email]", String(payload.email));
  if (payload.phone != null)
    fd.append("user[phone_number]", String(payload.phone));
  if (payload.birthday != null)
    fd.append("user[birthday]", String(payload.birthday));
  if (payload.location != null)
    fd.append("user[location]", String(payload.location));
